...
public class TicTacToeControllerTest {
  ...
  public void testOutOfBoundMove() {
    ...
    TicTacToeController c = new TicTacToeConsoleController(new StringReader("0 1"), gameLog);
    c.playGame(m);
  }
  ...
  public void testOccupiedMove() {
    TicTacToe m = new TicTacToeModel();
    StringBuilder gameLog = new StringBuilder();
    TicTacToeController c = new TicTacToeConsoleController(new StringReader("1 1 1 1"), gameLog);
    c.playGame(m);
  }

  @Test
  public void testGameCompletionWinner() {
    // test game completion and X wins.
    TicTacToe m = new TicTacToeModel();
    StringBuilder gameLog = new StringBuilder();
  ...
  @Test
  public void testQInsteadOfCol() {
    TicTacToe m = new TicTacToeModel();
    StringBuilder gameLog = new StringBuilder();
    TicTacToeController c = new TicTacToeConsoleController(new StringReader("1 q"), gameLog);
    c.playGame(m);
