...
public interface Questionnaire {
   ...
   *
   * @param identifier a name for the question
   *                   <b>unique</b> within this questionnaire. Not null or empty.
   ...
   * questionnaire, or the sorted order if the {@code sort()} method is called. The first
   * question is 1, second 2, etc.
   *
